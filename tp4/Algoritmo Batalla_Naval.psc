Algoritmo Batalla_Naval
	...
	Definir portaAvionesM, acorazadoM, lanchaM,totalBarcos, totalBarcosDestruidos  Como Entero
	Definir rendir, cancelar, salir Como Logico
	...
	Leer nombreUsuario
	Escribir 'Hola ',nombreUsuario,' Vamos a jugar a la batalla naval!, ¿que tan grande quieres el mapa?, ingrese un ejemplo es 8x9, donde 8 es fila y 9 la columna.'
	Leer sizeMap
	nFila <- 0
